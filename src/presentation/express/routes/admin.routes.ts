...
router.put('/members/:id/block',authMiddleware,(req,res,next)=>adminController.blockMember(req,res,next))
router.put('/members/:id/unblock',authMiddleware,(req,res,next)=>adminController.unblockMember(req,res,next))
