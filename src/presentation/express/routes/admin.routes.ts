...
router.post("/verify-members", (req, res, next) =>
...
router.get("/members", authMiddleware, (req, res, next) =>
  adminController.listUsers(req, res, next),
);
router.patch("/members/:id/block", authMiddleware, (req, res, next) =>
  adminController.blockMember(req, res, next),
);
