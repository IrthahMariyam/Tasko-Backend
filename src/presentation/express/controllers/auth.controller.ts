...
export class AuthController {
  constructor(
    @inject(USER_TYPES.ILoginUseCase) private readonly loginUseCase: ILoginUseCase,
    @inject(AUTH_TYPES.ILogoutUseCase) private readonly logoutUseCase: ILogoutUseCase,
    @inject(AUTH_TYPES.ISetPasswordUseCase) private readonly setPasswordUseCase: ISetPassWordUseCase,
    @inject(AUTH_TYPES.IForgotPasswordUseCase) private readonly forgotPasswordUseCase: IForgotPasswordUseCase,
    @inject(AUTH_TYPES.IVerifyForgotOtpUseCase) private readonly verifyForgotOtpUseCase: IVerifyForgotOtpUseCase,
    @inject(AUTH_TYPES.IResetPasswordUseCase) private readonly resetPasswordUseCase: IResetPasswordUseCase,
    @inject(AUTH_TYPES.IRefreshUseCase) private readonly refreshUseCase: IRefreshUseCase,
  ) {}
